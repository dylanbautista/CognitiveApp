...
let userEventOptions: [UserEventOption] = [
    ...
    UserEventOption(
        id: "ue9",
        text: "He tingut dificultats per mantenir l’atenció en una tasca llargues",
        domain: .attention
    ),
    UserEventOption(
        id: "ue10",
        text: "He necessitat més temps del normal per completar una tasca que abans feia ràpidament",
        domain: .speedProcessing
    )
]

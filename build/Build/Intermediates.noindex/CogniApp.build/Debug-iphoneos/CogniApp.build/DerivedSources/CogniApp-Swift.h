...
#ifndef COGNIAPP_SWIFT_H
#define COGNIAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CogniApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIButton;
@class UIEvent;
SWIFT_CLASS("_TtC8CogniApp11AppDelegate")
...
- (IBAction)push:(UIButton * _Nonnull)sender forEvent:(UIEvent * _Nonnull)event;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class UIWindow;
@class UIScene;
SWIFT_CLASS("_TtC8CogniApp13SceneDelegate")
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC8CogniApp14ViewController")
